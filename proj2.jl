...
# ╔═╡ 581c9062-e726-4d27-af7c-bf668066c2dd
#Query Function
...
# ╔═╡ 15c182a3-1abe-4f46-8267-771f7fcec197
begin
	nexsci_query_base_url = "https://exoplanetarchive.ipac.caltech.edu/TAP/sync?query="
	k2table = "k2pandc"
	url_get_k2table = make_tap_query_url(nexsci_query_base_url, k2table, where="default_flag=1")
end

# ╔═╡ 372ad0cb-6dbb-420e-8881-95638d6215ce
begin
	datadir = joinpath(pwd(),"data")
	mkpath(datadir)
end

# ╔═╡ fe3cec14-adcf-43f2-ad27-202b3ccf3fce
begin
	filename_ps = joinpath(datadir,"nexsci_ps.tsv")
	if !isfile(filename_ps) || filesize(filename_ps)==0
		Downloads.download(url_get_k2table, filename_ps)
		fresh_data_ps = true  
	else
		fresh_data_ps = false
	end
...
# ╔═╡ d0599c74-166b-4754-9d91-3fdabc5dc9b1
query_to_df(url) = CSV.read(HTTP.get(url).body,DataFrame)

# ╔═╡ daf180d8-9fff-467a-bf8f-9c9588bc33cb
df_k2_table = query_to_df(url_get_k2table)

# ╔═╡ 825a9f91-0b81-4710-9eb6-f14f35713ee8
df_k2_filtered = filter(row->!ismissing(row.pl_projobliq) && !ismissing(row.pl_orbper), df_k2_table)
